...
def getamazondata(datasetpath, storepath, prefix):
    print('**********************************')
    print('Generate amazon graph')
    print('**********************************')
    
    amazon_path = datasetpath+'amazon/Amazon.mat'
    ...
    amazon_graph_structure = {
            ('r','homo','r'):(torch.tensor(homo.row).long(), torch.tensor(homo.col).long()),
            ('r','p','r'):(torch.tensor(upu.row).long(), torch.tensor(upu.col).long()),
            ('r','s','r'):(torch.tensor(usu.row).long(), torch.tensor(usu.col).long()),
            ('r','v','r'):(torch.tensor(uvu.row).long(), torch.tensor(uvu.col).long())
    }
    ...
    amazon_graph.nodes['r'].data['feature'] = features.float()
    amazon_graph.nodes['r'].data['label'] = labels.float()
    ...
    dgl.save_graphs(storepath+prefix+'amazon.dgl', amazon_graph)
...
def getyelpdata(datasetpath, storepath, prefix):
    print('**********************************')
    print('Generate yelp graph')
    print('**********************************')
    yelp_path = datasetpath+'yelp/YelpChi.mat'
    ...
    yelp_graph_structure = {
        ('r','homo','r'):(torch.tensor(homo.row).long(), torch.tensor(homo.col).long()),
        ('r','u','r'):(torch.tensor(rur.row).long(), torch.tensor(rur.col).long()),
        ('r','t','r'):(torch.tensor(rtr.row).long(), torch.tensor(rtr.col).long()),
        ('r','s','r'):(torch.tensor(rsr.row).long(), torch.tensor(rsr.col).long())
    }
    ...
    dgl.save_graphs(storepath+prefix+'yelp.dgl', yelp_graph)
...
def getdata(datasetpath, storepath, dataset, prefix):
    if dataset=='amazon':
        getamazondata(datasetpath, storepath, prefix)
    
    if dataset=='yelp':
        getyelpdata(datasetpath, storepath, prefix)
